...
{
    public class ExcelReportFormatter : IDisposable
    {
        ...
        public void FormatReport(ExcelReportInfo info, List<ExcelReportItem> items)
        {
            FormatHeader(info);
        ...
        private void FormatHeader(ExcelReportInfo info)
        {
        ...
        private string CalcDuration(ExcelReportItem item)
        {
